...
import { Template1 } from '@/lib/Templates/Template1/Template1'
...
const ResumePreview = ({ Sheetref, setisSheetOpen, isGenerating, setisGenerating }: { Sheetref: RefObject<BottomSheetModal | null>, setisSheetOpen: React.Dispatch<React.SetStateAction<boolean>>, isGenerating: boolean, setisGenerating: Setter<boolean> }) => {
    ...
    }, [ResumeContent,Template1(ResumeContent)]);
